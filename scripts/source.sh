...
[ -d ./memtest86plus ] || git clone --depth 1 -b v8.00 https://github.com/memtest86plus/memtest86plus.git
...
[ -d ./perl5 ]         || git clone --depth 1 -b v5.42.0 https://github.com/Perl/perl5.git
