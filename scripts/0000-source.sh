...
[ -d ./gnulib ]        || git clone --depth 1 -b v1.0 https://github.com/coreutils/gnulib.git ./gnulib # git://git.sv.gnu.org/gnulib.git https://gitweb.git.savannah.gnu.org/gitweb/?p=gnulib.git
