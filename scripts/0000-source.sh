...
[ -d ./gnulib ]        || git clone --depth 1 -b v1.0 https://github.com/coreutils/gnulib.git # https://git.savannah.gnu.org/git/gnulib.git git://git.sv.gnu.org/gnulib.git https://gitweb.git.savannah.gnu.org/gitweb/?p=gnulib.git
